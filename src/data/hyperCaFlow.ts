...
export const hyperCaFlow: WorkupFlowDef = {
  ...
  steps: [
    ...
    // Results
    {
      ...
      treatment: '手術適応（2022年第4回国際ワークショップ）：年齢 < 50歳・補正Ca > 正常上限+1.0 mg/dL・腎結石/腎石灰化・骨密度T-score < -2.5（いずれかの部位）・eGFR < 60・椎体骨折。\n手術非適応：シナカルセト（骨には効果薄）・ビスホスホネート（骨密度改善）。\n水分摂取促進・低Ca食。',
      resultColor: 'yellow',
    },
    {
      id: 'result_fhh',
    ...
    },
    {
      ...
      treatment: '【緊急対応】①生理食塩水大量補液（3〜4 L/日）②カルシトニン（サーモンカルシトニン 4 IU/kg sc/im q12h）→ 即効性あり（4〜6時間で効果）。ただし48時間でタキフィラキシー ③ビスホスホネート（ゾレドロン酸 4mg iv）→ 効果発現に2〜4日 ④デノスマブ（腎不全時に有用）⑤ステロイド（リンパ腫・VitD関連）\n原発腫瘍の治療。',
      resultColor: 'red',
    },
    {
      id: 'result_granuloma',
